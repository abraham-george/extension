declare module ORACLE_SERVICE_CLOUD {
    ...
    export interface IStandardText {
        event: IEvent;
        standardText: string;
        plainStandardText: string;
        standardTextId?: number;
    ...
    export interface IEvent {
        ...
        fieldObjects?: { [fieldObject: string]: IFieldObject };
    }
    ...
    export interface IWorkspaceRecord extends IUserInterface {
        ...
        addRecordAcceptingListener(callbackFunctionReference: (param: IWorkspaceRecordEventParameter) => void, context?: any): ORACLE_SERVICE_CLOUD.IWorkspaceRecord;
        addRecordRejectingListener(callbackFunctionReference: (param: IWorkspaceRecordEventParameter) => void, context?: any): ORACLE_SERVICE_CLOUD.IWorkspaceRecord;
        ...
        invokeGuide(guideId: number): IExtensionPromise<void>;
        getContainerId(): string;
        getGroupContainerId(): string;
        getTimeBilled(): IExtensionPromise<ITimeBilled>;
    }
    export interface IExtensionWorkGroupContext {
        ...
        findAndFocus(entityType: string, entityId: number, callbackFunctionReference?: (param: IWorkspaceRecord) => void): boolean;
        editWorkGroupEntity(entityType: string, entityId: number, config: IWorkspaceConfig, callbackFunctionReference?: (param: IWorkspaceRecord) => void): IExtensionPromise<IWorkGroupEntity>;
    ...
    export interface IExtensionProvider extends IExtensionDisposable {
        ...
        registerAnalyticsExtension(userFunction: (param: ORACLE_SERVICE_CLOUD.IAnalyticsContext) => void): void;
        getGlobalContext(): ORACLE_SERVICE_CLOUD.IExtensionPromise<IExtensionGlobalContext>;
        getInsightsContext(): IExtensionPromise<IInsightsContext>;
    ...
    export interface IAnalyticsContext {
        ...
        addTableDataModifiedRequestListener(tableName: string, callback: (param: IEditedReportDataContext) => void): IAnalyticsContext;
        addExternalMenuDataRequestListener(columnReference: string, callback: (param: IExternalMenuExecutionContext) => IExtensionPromise<IExternalMenuResultSet>): IAnalyticsContext;
        createRecordCommandContext(commandName: string): IRecordCommandContext;
    ...
    export interface IIncidentWorkspaceRecord extends IWorkspaceRecord {
        ...
        getCurrentEditedThreadType(): IExtensionPromise<string>;
    }
    ...
    export interface IInsightsContext {
        registerAction(actionName: string, callbackFunction: (param: any) => any): void;
        handleInsightRequestReady(param: IInsightRequest[]): IExtensionPromise<void>;
        handleInsightResponseReady(param: IInsightResponse[]): IExtensionPromise<void>;
        getExistingInsights(param: IInsightRequest[]): IExtensionPromise<IInsightResult>;
        removeInsight(param: IInsightRequest[]): IExtensionPromise<void>;
        replaceAllInsights(param: IInsightRequest[]): IExtensionPromise<void>;
        createIInsightSuggestionResponse(): IInsightSuggestionResponse;
        createIInsightRequest(): IInsightRequest;
        createIInsightResponse(): IInsightResponse;
    }

    export interface IInsightRequest {
        getContextId(): string;
        getInsightConnectionId(): number;
        getRequest(): any;
        getInsightId(): string;
        getInsights(): IInsightSuggestionResponse[];
        setContextId(contextId: string): void;
        setInsightConnectionId(insightConnectionId: number): void;
        setRequest(request: any): void;
        setInsightId(insightId: string): void;
        setInsights(insights: IInsightSuggestionResponse[]): void;
    }

    export interface IInsightResponse {
        getContextId(): string;
        getResponse(): IInsightSuggestionResponse[];
        setContextId(contextId: string): void;
        setResponse(response: IInsightSuggestionResponse[]): void;
    }

    export interface IInsightSuggestionResponse {
        getConfidence(): number;
        getInsightType(): string;
        getInsightField(): string;
        getInsightValue(): string;
        getRationale(): string;
        getDescription(): string;
        getInsightLocale(): string;
        getComments(): string;
        getWorkspaceRuleSource(): string;
        getIsInsightIdProvidedByExternalService(): boolean;
        getVerticalLayoutPriority(): string;
        getInsightId(): string;
        getOnAcceptInsightAction(): string;
        getOnDismissInsightAction(): string;

        setConfidence(confidence: number): void;
        setInsightType(aiSuggestionType: string): void;
        setInsightField(insightField: string): void;
        setInsightValue(insightValue: string): void;
        setRationale(rationale: string): void;
        setDescription(description: string): void;
        setInsightLocale(insightLocale: string): void;
        setComments(comments: string): void;
        setWorkspaceRuleSource(workspaceRuleSource: string): void;
        setIsInsightIdProvidedByExternalService(isInsightIdProvidedByExternalService: boolean): void;
        setVerticalLayoutPriority(verticalLayoutPriority: string): void;
        setInsightId(insightId: string): void;
        setOnAcceptInsightAction(onAcceptInsightAction: string): void;
        setOnDismissInsightAction(onDismissInsightAction: string): void;
    }

    export interface IInsightResult {
        getResult(): IInsightData[][];
        setResult(result: IInsightData[][]): void;
    }
    ...
    export interface IInsightData {
        ...
        getComments(): string;
        getConfidence(): number;
        getCustomActions(): {key: string, label: string, icon: string}[];
        shouldHideCard(): boolean;
        getIcon(): string;
        getInsightId(): string;
        getIsInsightIdProvidedByExternalService(): boolean;
        getIsStackedCard(): boolean;
        getOnAcceptInsightAction(): string;
        getOnDismissInsightAction(): string;
        getPrimaryActionLabel(): string;
        getRationale(): string;
        shouldShowTitleAsLink(): boolean;
        getTitle(): string;
        getVerticalLayoutPriority(): string;
        getWorkspaceRuleSource(): string;

        setActionParameters(actionParameters: string[]): void;
        setActionType(actionType: string): void;
        setBody(body: string): void;
        setChildCount(childCount: number): void;
        setComments(comments: string): void;
        setConfidence(confidence:number): void;
        setCustomActions(customActions: {key: string, label: string, icon: string}[]): void;
        setHideCard(hideCard: boolean): void;
        setIcon(icon: string): void;
        setInsightId(insightId: string): void;
        setInsightIdProvidedByExternalService(isInsightIdProvidedByExternalService: boolean): void;
        setStackedCard(isStackedCard: boolean): void;
        setOnAcceptInsightAction(onAcceptInsightAction: string): void;
        setOnDismissInsightAction(onDismissInsightAction: string): void;
        setPrimaryActionLabel(primaryActionLabel: string): void;
        setRationale(rationale: string): void;
        setShowTitleAsLink(showTitleAsLink: boolean): void;
        setTitle(title: string): void;
        setVerticalLayoutPriority(verticalLayoutPriority: string): void;
        setWorkspaceRuleSource(workspaceRuleSource: string): void;
    }
    ...
    export interface IScriptContext {
        getAllVisitedScripts(): IExtensionPromise<IScriptDetails[]>;
        ...
        getScriptAuditById(scriptId: number): IExtensionPromise<IScriptAuditEntry[]>;
    }
    ...
    export interface IScriptQuestion {
        ...
        getScriptPageId(): number;
        getScriptPageName(): string;
    }
    ...
    export interface IScriptAuditEntry {
        getActions(): IScriptAuditAction[];
        getParentId(): number;
        getScriptId(): number;
        getScriptSession(): string;
    }

    export interface IScriptAuditAction {
        getPageId(): number;
        getPageName(): string;
        getType():string;
    }

    export interface IScriptExitFinishAuditAction extends IScriptAuditAction {
        getTimeStamp(): Date;
    }

    export interface IScriptGoToPageAuditAction extends IScriptAuditAction {
        getTimeSwitched(): Date;
        getTimeVisited(): Date;
    }

    export interface IScriptPageLoadedAuditAction extends IScriptAuditAction {
        getTimeLoaded(): Date;
    }

    export interface IScriptQuestionResponseAuditAction extends IScriptAuditAction {
        getQuestion(): string;
        getResponse(): string | string[];
        getTimeStamp(): Date;
    }

    export interface ITimeBilled {
        getTimeBilledEntries(): IExtensionPromise<ITimeBilledEntries>;
    }

    export interface ITimeBilledEntries {
        getTimeBilledEntryList(): IExtensionPromise<ITimeBilledEntry[]>;
        addNewTimeBilledEntry(): ITimeBilledEntry;
        apply(): IExtensionPromise<any>;
    }

    export interface ITimeBilledEntry {
        getDate(): Date;
        getBilledBy(): number;
        getBillableTaskId(): number;
        getDuration(): number;
        getNotes(): string;
        getTimeBilledId(): number;
        setDate(date: Date);
        setBilledBy(billedBy: number);
        setBillableTaskId(billableTaskId: number);
        setDuration(duration: number);
        setNotes(notes: string);
    }

    export interface ILanguageTranslationRequest {
        text: string;
    ...
    export interface ILanguageTranslationTransformedRequest {
       headerParams?: any;
       queryParams?: any;
       payload?: any;
    }

    export interface ILanguageTranslationResponse {
        payload: any;
        translationType: string;
    }
    export interface ILanguageTranslationTransformedResponse {
        translatedText?: any;
        error?: IError;
    }

    export interface ILanguageDetectionTransformedResponse {
    ...
    export interface ILanguageTranslationLog {
        inputText?: string,
        requestPayload?: any,
        responseData?: any;
        status?: string,
        ...
        threadId?: number,
        targetLanguageCode?: string,
        inferredLanguage?: IDetectedLanguage,
        errorString?: string,
    }
...
declare let ExtensionPromise: { new(handler?: ((resolve: any, reject: any) => void)): IExtensionPromise<any> };
...
declare type IFieldDetails = ORACLE_SERVICE_CLOUD.IFieldDetails;
declare let ErrorData: { new(getDesc: string): IErrorData};
declare type IInsightsContext = ORACLE_SERVICE_CLOUD.IInsightsContext;
declare type ITimeBilled = ORACLE_SERVICE_CLOUD.ITimeBilled;
declare type ITimeBilledEntries = ORACLE_SERVICE_CLOUD.ITimeBilledEntries;
declare type ITimeBilledEntry = ORACLE_SERVICE_CLOUD.ITimeBilledEntry;
declare type IInsightRequest = ORACLE_SERVICE_CLOUD.IInsightRequest;
declare type IInsightResponse = ORACLE_SERVICE_CLOUD.IInsightResponse;
declare type IInsightSuggestionResponse = ORACLE_SERVICE_CLOUD.IInsightSuggestionResponse;
declare type IInsightData = ORACLE_SERVICE_CLOUD.IInsightData;
declare type IInsightResult = ORACLE_SERVICE_CLOUD.IInsightResult;
declare type ILanguageTranslationRequest = ORACLE_SERVICE_CLOUD.ILanguageTranslationRequest;
declare type ILanguageTranslationTransformedRequest = ORACLE_SERVICE_CLOUD.ILanguageTranslationTransformedRequest;
declare type ILanguageTranslationResponse = ORACLE_SERVICE_CLOUD.ILanguageTranslationResponse;
declare type ILanguageTranslationTransformedResponse = ORACLE_SERVICE_CLOUD.ILanguageTranslationTransformedResponse;
declare type ILanguageDetectionTransformedResponse = ORACLE_SERVICE_CLOUD.ILanguageDetectionTransformedResponse;
declare type IDetectedLanguage = ORACLE_SERVICE_CLOUD.IDetectedLanguage;
declare type IError = ORACLE_SERVICE_CLOUD.IError;
declare type ILanguageTranslationLog = ORACLE_SERVICE_CLOUD.ILanguageTranslationLog;
